**Generated on:** 2026-02-11 10:22:46
...
└── uploads
    └── ingest
        └── audio
            └── voice_note.mp4
            └── voice_note_6XuUVTc.mp4
            └── voice_note_cPdzSKw.mp4
            └── voice_note_xxgTI5L.mp4
    └── uploads
        └── 2026
            └── 01
                └── test.txt
...
```python
def def ingest_media(file_obj=None, text_input=None, audio_file=None):
